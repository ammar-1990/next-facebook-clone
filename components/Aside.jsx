...
const Aside = () => {
  ...
  return (
    <aside className=" px-1 sm:px-4 py-2 w-max lg:w-1/4 hidden sm:flex flex-col items-center  ">
<AsideRow profile={userInfo.image} title={{name:userInfo.name,last:userInfo.lastname}} email={userInfo.email}/>
